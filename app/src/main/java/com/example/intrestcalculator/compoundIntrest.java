...
public class compoundIntrest extends AppCompatActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_compound_intrest);
        ...
        sDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(
                        compoundIntrest.this, android.R.style.Theme_DeviceDefault_Light_Dialog_MinWidth,setListener1,year1,month1,day1);
        ...
        eDate.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                DatePickerDialog datePickerDialog=new DatePickerDialog(
                        compoundIntrest.this, android.R.style.Theme_DeviceDefault_Light_Dialog_MinWidth,setListener2,year2,month2,day2);
                datePickerDialog.show();
            }
        });
        ...
        sub.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (checkEmptyFileds(p, r,sDate,eDate)) {
                    ...
                    Toast.makeText(compoundIntrest.this, "Please enter all the values", Toast.LENGTH_SHORT).show();
                float i = P * R / 100;
                ...
                fAmount.setText(s4);
                String str="For"+a[0]+" Days "+a[1]+" Months"+" and "+a[2]+" Years";
                time.setText(str);
            }
        });
    ...
    boolean checkEmptyFileds(EditText p, EditText r,EditText sDate,EditText eDate) {
        boolean b = true;
        if (p.getText().toString().equals("") || r.getText().toString().equals("") || sDate == null || eDate==null) {
            b = false;
        }
        return b;
    }
